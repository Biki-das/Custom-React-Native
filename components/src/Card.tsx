...
const cards = images.map(image => ({
  amount: faker.finance.amount(50, 9999, faker.datatype.number(2), '$'),
  bg: image,
  cardType: faker.helpers.arrayElement(cardType),
  type: faker.helpers.arrayElement(['gold', 'silver', 'platinum']),
