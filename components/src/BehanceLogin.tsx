...
const BehanceLogo = () => {
  return (
    <View style={styles.logo}>
      <Image
        source={{
          uri: 'https://user-images.githubusercontent.com/2805320/126218158-2c5b55d1-6eec-4553-b516-ecede5027329.png',
        }}
      ...
      <BottomSheetModalProvider>
        ...
        <View style={styles.container}>
          ...
          <View
            ...
            <Image
              source={{
                uri: 'https://user-images.githubusercontent.com/2805320/126218163-6736ba78-e7ae-4575-8486-0eadc90753fc.png',
              }}
              style={{
                width: width * 0.3,
                height: 30,
